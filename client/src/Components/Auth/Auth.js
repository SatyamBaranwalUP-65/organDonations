...
const Auth = (props) => {
  ...
  const s1 =
    "mx-2 px-9 py-2 font-semibold rounded-full shadow-sm text-white-900 bg-blue-500 hover:drop-shadow-md hover:opacity-80 cursor-pointer";
  useEffect(() => {
  ...
  const generatePDF = () => {
    ...
    link.href = "/assets/FORM.pdf"; // Update the path if necessary
    link.download = "FormToBeFilled.pdf"; // The name for the downloaded file
        ...
        >
          ...
          >
             <div className="flex justify-center items-center mt-10">
                        {handle !== "bank" && ( // Check if handle is not equal to an empty string
                          <button
